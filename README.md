# TechTalk, Freiburg 2024, Decembre
...
**database migration**
```
DATABASE_URL="postgresql://postgres:postgres@localhost:5436/todo_db?schema=public" npx prisma migrate dev --name add_urgency
...
**add component topage.tsx**
```
// also change interface of todos
// and add to the map() of different todos like <UrgencyBagde urgency={todo.urgency}/>
